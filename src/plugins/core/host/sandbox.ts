...
export class PluginSandbox {
  ...
  public getCSP(): string {
    ...
    // Ensure inline scripts (like the bootstrap) are allowed in the iframe's CSP
    if (cspOptions.scriptSrc && !cspOptions.scriptSrc.includes("'unsafe-inline'")) {
      cspOptions.scriptSrc.push("'unsafe-inline'");
    }
