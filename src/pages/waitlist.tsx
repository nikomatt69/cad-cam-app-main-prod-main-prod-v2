  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4 py-16">
        ...
        <h1 className="text-4xl sm:text-3xl flex items-center px-2 sm:px-5 font-bold text-gray-900">
              <img src='/logo.png' className='h-full sm:h-28 mr-2' alt="Logo"/>
            </h1>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1 bg-gray-100 dark:bg-gray-800 rounded-lg p-6">
              <div className="aspect-video bg-gray-200 dark:bg-gray-700 rounded flex items-center justify-center">
                <Image src="/fullcad.png" alt="CADCAMFUN" width={1000} height={1000} />
