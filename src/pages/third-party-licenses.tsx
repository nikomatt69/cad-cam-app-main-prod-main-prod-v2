      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 bg-white dark:bg-gray-800 shadow rounded-lg">
        ...
        <section>
          ...
          <p className="mt-6 text-xs text-gray-500 dark:text-gray-400">
            This list may not be exhaustive and primarily includes major dependencies. For a complete list of dependencies and their licenses, you may inspect our applications source code or contact us.
          </p>
        </section>
