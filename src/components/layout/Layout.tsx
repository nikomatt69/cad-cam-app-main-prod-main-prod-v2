      ...
      <div className="flex flex-1 rounded-xl rounded-t-none overflow-hidden">
        ...
        <div className={`flex-1 flex flex-col transition-all duration-300 ${
          ...
          {showScrollTop && (
            <button
              onClick={scrollToTop}
              className="fixed bottom-32 right-4 bg-blue-600 hover:bg-blue-700 text-white p-2 rounded-full shadow-lg transition-opacity duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 z-40"
